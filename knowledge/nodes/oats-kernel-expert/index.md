...
* [Integrity, origin and consent are different proofs](decisions/trust-approval-and-consent-boundaries.md) - Contained reproducible bytes, consistent provenance and explicit host-install consent answer distinct trust questions.
